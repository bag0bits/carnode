...
WORKDIR /home/cardano/src/secp256k1
...
## Now to Cardano node and cli (tag 1.35.0)
############################################
...
RUN cp ./dist-newstyle/build/x86_64-linux/ghc-8.10.7/cardano-node-1.35.0/x/cardano-node/noopt/build/cardano-node/cardano-node /home/cardano/.local/bin/
RUN cp ./dist-newstyle/build/x86_64-linux/ghc-8.10.7/cardano-cli-1.35.0/x/cardano-cli/noopt/build/cardano-cli/cardano-cli /home/cardano/.local/bin/
